...
open class FPNCountryRepository {
	...
	private func getAllCountries() -> [FPNCountry] {
		// Hardcoded country data (replace with actual data from countryCodes.json)
		let countryData: [[String: String]] = [
			...
			["code": "AS", "dial_code": "+1", "name": "AmericanSamoa"],
			["code": "AD", "dial_code": "+376", "name": "Andorra"],
			["code": "AO", "dial_code": "+244", "name": "Angola"],
			["code": "AI", "dial_code": "+1", "name": "Anguilla"],
			["code": "AG", "dial_code": "+1", "name": "Antigua and Barbuda"],
			...
			["code": "BM", "dial_code": "+1", "name": "Bermuda"],
			...
			["code": "KY", "dial_code": "+1", "name": "Cayman Islands"],
			...
			["code": "CD", "dial_code": "+243", "name": "Congo, The Democratic Republic of the Congo"],
			...
			["code": "DM", "dial_code": "+1", "name": "Dominica"],
			["code": "DO", "dial_code": "+1", "name": "Dominican Republic"],
			...
			["code": "GD", "dial_code": "+1", "name": "Grenada"],
			["code": "GP", "dial_code": "+590", "name": "Guadeloupe"],
			["code": "GU", "dial_code": "+1", "name": "Guam"],
			...
			["code": "IR", "dial_code": "+98", "name": "Iran, Islamic Republic of Persian Gulf"],
			...
			["code": "JM", "dial_code": "+1", "name": "Jamaica"],
			...
			["code": "KP", "dial_code": "+850", "name": "Korea, Democratic People's Republic of Korea"],
			["code": "KR", "dial_code": "+82", "name": "Korea, Republic of South Korea"],
			...
			["code": "MT_IL", "dial_code": "+356", "name": "Malta"],
			...
			["code": "FM", "dial_code": "+691", "name": "Micronesia, Federated States of Micronesia"],
			...
			["code": "MS", "dial_code": "+1", "name": "Montserrat"],
			...
			["code": "MP", "dial_code": "+1", "name": "Northern Mariana Islands"],
			...
			["code": "KN", "dial_code": "+1", "name": "Saint Kitts and Nevis"],
			["code": "LC", "dial_code": "+1", "name": "Saint Lucia"],
			["code": "MF", "dial_code": "+590", "name": "Saint Martin"],
			["code": "PM", "dial_code": "+508", "name": "Saint Pierre and Miquelon"],
			["code": "VC", "dial_code": "+1", "name": "Saint Vincent and the Grenadines"],
			...
			["code": "TZ", "dial_code": "+255", "name": "Tanzania, United Republic of Tanzania"],
			...
			["code": "VE", "dial_code": "+58", "name": "Venezuela, Bolivarian Republic of Venezuela"],
			["code": "VN", "dial_code": "+84", "name": "Vietnam"],
			["code": "VG", "dial_code": "+1", "name": "Virgin Islands, British"],
			["code": "VI", "dial_code": "+1", "name": "Virgin Islands, U.S."],
		...
		for countryObj in countryData {
			guard let code = countryObj["code"],
				let phoneCode = countryObj["dial_code"],
				let name = countryObj["name"] else {
				continue
			}
